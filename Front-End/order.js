const ORDER_URL = 'http://localhost:3000/api/orders/place-order';
const CART_URL = 'http://localhost:3000/api/cards';
const PRODUCTS_API_URL = 'http://localhost:3000/api/store/products';
